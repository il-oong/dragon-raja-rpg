...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  ...
  talk(npcName) {
    ...
    const lines = {
      '촌장': '"또 왔군, 후보. ...심상치 않은 게 한두 가지가 아니라 미안하네."',
      '대장장이 게롤트': '"강철은 두드려야 나온다. 말은 얹지 말고."',
      '술집주인 메이린': '"한 잔 하려나, 아니면 이야기만 들으러 온 겐가. 둘 다 돈을 받는 건 같네만."',
      '장로 엘리안': '"바람이 심상치 않다. ...엘프에게 이 말은 대개 평소와 같다는 뜻이기도 하지."',
      '상인 실바나': '"엘프의 활시위는 엘프 손을 거쳐야 팔리지. 어느 쪽 손이든 상관없다는 뜻이다."',
      '수색자 카일란': '"발자국을 읽는 법을 가르쳐 주랴? ...대체로는 발자국이 당신을 먼저 읽는다."',
      '왕궁 마법사 핸드레이크': '"드래곤 라자의 전승이라. 자네가 그 아이인가, 아니면 또 내 노안이 실수한 것인가."',
      '기사단장 리프크네': '"검을 든 자여, 왕국이 그대를 부른다. 거절은 가능하지만 흔치 않지."',
      '대주교 유스티스': '"신의 뜻이 그대와 함께. 있을 때도 없을 때도 있으나, 그건 내가 판단할 일이 아니네."',
      '암살자 길드장': '"...그림자는 이미 그대를 안다. 소개는 필요 없겠군."',
      '궁사 길드장 이무스': '"천 걸음 밖 과녁을 맞히는 법을 아나? ...과녁이 가만히 있어주는 것이 먼저일세."',
      '국왕 다케온': '"아무르타트가 깨어났다. 짐이 깨웠다는 소문은 ...유감스럽지만 사실이 아니라네."',
      '재상': '"폐하께서 부르실 것이오. 먼저 부르지 마시오."',
      '암흑 사제 모르간': '"...죽음은 끝이 아닐세. 그게 위안인지 협박인지는 사람마다 다르지."',
      '대장장이 마스터 흐랄': '"미스릴은 비싸다. 그만큼 값을 한다. 불평은 주문 이후에."',
      '상인 길드장 자히드': '"황금만큼 정직한 것은 없지. 거짓말은 했을지언정, 나는 금화와는 거짓말을 하지 않는다."',
      '검투사 챔피언 라크살': '"투기장에서 살아남은 자만 전사다. 죽은 자는 전설이 되고, 도망친 자는 관중이 되지."',
      '수련생 알라잔': '"탑의 마지막 층은 아직 못 가봤네. 스승이 언제나 중간에서 잠드셔서."',
      '후치 네드발': '"후치 네드발이오. 드래곤 라자의 후보... 정확히는 도망자에 가깝소."',
      '이루릴 나슬리야': '"이루릴이다. 후치 때문에 곤경에 빠진 일행들을 대표한다."',
      '샌슨 퍼시벌': '"샌슨 퍼시벌. 가장 짧은 설교로 유명한 성직자요."',
    };
    this.out('\n' + (lines[npc] || `${npc}: "..."`));
